...
feature_pth = '/home/frank/center/features/centerloss_track'
...
def tsne():
    ...
    for i in random.sample(range(0,length),1000):
    ...
    color_dic = ['red', 'blue', 'purple', 'green', 'orange']
    g = sn.FacetGrid(tsne_df, hue="label", size=6, palette=color_dic).map(plt.scatter, 'Dim_1', 'Dim_2').add_legend()
    ...
    plt.savefig("tsne_center_raw.png")
